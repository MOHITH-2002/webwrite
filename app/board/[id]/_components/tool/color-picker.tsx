...
export const ColorPicker = ({
  ...
  return (
    ...
    >
      ...
      <ColorButton color={{ r: 124, g: 252, b: 0 }} onClick={onChange} />
      <ColorButton color={{ r: 0, g: 255, b: 255 }} onClick={onChange} />
      <ColorButton color={{ r: 139, g: 69, b: 19}} onClick={onChange} />
      <ColorButton color={{ r: 188, g: 143, b: 143 }} onClick={onChange} />
